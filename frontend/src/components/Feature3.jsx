...
const Feature3 = () => {
  ...
  const faqData = [
    {
      ...
      answer:
        "We offer comprehensive digital solutions including Web Development, Mobile App Development, Software Development, AI/ML Development, and Digital Marketing services. Our team specializes in creating custom solutions tailored to your business needs.",
    },
    {
      question: "How Long Does It Take To Complete A Project?",
      answer:
        "Project timelines vary depending on complexity and scope. Typically, web development projects take 2-8 weeks, mobile apps take 6-16 weeks, and enterprise software solutions can take 3-6 months. We provide detailed timelines during our initial consultation.",
    },
    {
      question: "Do You Provide Ongoing Support After The Project Is Complete?",
      answer:
        "Yes, we provide comprehensive post-launch support including bug fixes, updates, maintenance, and technical support. We offer various support packages to ensure your solution continues to perform optimally and stays up-to-date with the latest technologies.",
    },
    {
      question: "Can I See Examples Of Your Previous Work?",
      answer:
        "Absolutely! We have a portfolio showcasing our previous projects across various industries. You can view our case studies, client testimonials, and live project examples. We'd be happy to share relevant examples that match your project requirements during our consultation.",
    },
  ];
  ...
  return (
    <section className="pb-10 sm:pb-12 lg:pb-14 px-4 sm:px-6 lg:px-8 bg-gray-50">
